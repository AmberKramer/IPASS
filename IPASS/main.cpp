...
while(true){
    ...
    if(button.read()){
        Chamber.SetServoPosition(1);
        if (color==kleurtjes::brown || color==kleurtjes::none){
            hwlib::wait_ms(1000);
            Chamber.SetServoPosition(2);
        }
        else if (color==kleurtjes::red){
            Red.SetServoPosition(2);
            hwlib::wait_ms(5);
            Chamber.SetServoPosition(1);
            hwlib::wait_ms(1000);
            Chamber.SetServoPosition(2);
            hwlib::wait_ms(1000);
            Red.SetServoPosition(1);
        }
        else if (color==kleurtjes::orange){
            Orange.SetServoPosition(2);
            hwlib::wait_ms(5);
            Chamber.SetServoPosition(1);  
            hwlib::wait_ms(1000);
            Chamber.SetServoPosition(2);
            hwlib::wait_ms(1000);
            Orange.SetServoPosition(1);
        }
        else if(color==kleurtjes::yellow){
            Yellow.SetServoPosition(2);
            hwlib::wait_ms(5);
            Chamber.SetServoPosition(1);
            hwlib::wait_ms(1000);
            Chamber.SetServoPosition(2);
            hwlib::wait_ms(1000);
            Yellow.SetServoPosition(1);
        }
        else if(color==kleurtjes::green){
            Green.SetServoPosition(2);
            hwlib::wait_ms(5);
            Chamber.SetServoPosition(1);
            hwlib::wait_ms(1000);
            Chamber.SetServoPosition(2);
            hwlib::wait_ms(1000);
            Green.SetServoPosition(1);
        }
        else if(color==kleurtjes::blue){
            Blue.SetServoPosition(2);
            hwlib::wait_ms(5);
            Chamber.SetServoPosition(1);
            hwlib::wait_ms(1000);
            Chamber.SetServoPosition(2);
            hwlib::wait_ms(1000);
            Blue.SetServoPosition(1);
        }
    }
